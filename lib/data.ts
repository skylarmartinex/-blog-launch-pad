...
export const tasksData: Record<string, Task[]> = {
  day1: [
    { id: 'd1-1', text: 'Define Your Niche Statement', time: '20 min', hint: 'Create your "I help [audience] use [tools] to achieve [outcome]" statement', guideUrl: '/guides/define-your-niche' },
    { id: 'd1-2', text: 'Brainstorm Blog Names', time: '15 min', hint: 'Generate 10-15 creative name ideas for your blog', guideUrl: '/guides/brainstorm-blog-names' },
    { id: 'd1-3', text: 'Check Domain Availability', time: '10 min', hint: 'Verify which names are available as .com domains', guideUrl: '/guides/check-domain-availability' },
